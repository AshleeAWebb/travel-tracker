...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* General CSS Elements */\n* {\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  width: 100%;\n  font-size: 20px;\n  font-family: 'Lato', sans-serif;\n  display: flex;\n  flex-direction: column;\n  overflow-x: hidden;\n}\n\nheader {\n  width: 100%;\n  font-family: 'Original Surfer', cursive;\n  background: rgba(244, 220, 204, 0.8);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  display: flex;\n  justify-content: space-between;\n  flex-direction: row;\n  align-items: center;\n  z-index: 1;\n}\n\nh1,\nh2 {\n  margin: 10px;\n}\n\nh2 {\n  display: flex;\n  justify-content: center;\n}\n\np {\n  text-align: center;\n}\n\n/* buttons & input fields*/\nbutton,\n.submit {\n  font-family: 'Original Surfer', cursive;\n  border-radius: 50px;\n  background: rgba(244, 220, 204, 0.5);\n  box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.25);\n  padding: 10px;\n  border: none;\n  font-size: 30px;\n  cursor: pointer;\n  margin: 15px;\n}\n\nbutton:hover,\n.submit:hover {\n  background-color: #544948;\n  color: white;\n}\n\n.close-btn {\n  margin: 10px;\n  color: black;\n  float: right;\n  font-size: 36px;\n  font-weight: bold;\n}\n\n.close {\n  color: #aaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n.confirm-button,\n.decline-button {\n  font-family: 'Lato', sans-serif;\n  font-size: 20px;\n  padding: 5px;\n}\n\n.input-box {\n  padding: 2%;\n  width: 500px;\n  justify-content: space-between;\n}\n\ninput {\n  font-size: 16px;\n  padding: 10px;\n  border: 1px solid #ccc;\n  border-radius: 5px;\n  font-family: 'Lato', sans-serif;\n  border-radius: 50px;\n}\n\ninput:focus {\n  outline: none;\n  border-color: rgba(0, 0, 0, 0.25);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n}\n\n/* Login Page */\n.login-page {\n  position: relative;\n  width: 100vw;\n  height: 100vh;\n  z-index: inherit;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.login-form {\n  display: flex;\n  padding: 15px;\n  font-family: 'Lato', sans-serif;\n  background: rgba(244, 220, 204, 0.5);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  width: 300px;\n  height: 190px;\n  flex-direction: column;\n  align-items: stretch;\n  justify-content: space-around;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 2;\n  border-radius: 30px;\n  padding: 20px;\n}\n\n.login-image {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-size: cover;\n  background-position: center;\n  z-index: 0;\n}\n\n/* Dashboard Page */\n.dashboard-page {\n  height: 100vh;\n  background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n}\n\n.dashboard-container {\n  height: 100%;\n}\n\n.book-trip {\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  align-items: center;\n}\n\n.modal {\n  display: none;\n  justify-content: center;\n  align-items: center;\n  position: fixed;\n  z-index: 1;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.modal.show {\n  display: flex;\n}\n\n.modal-content {\n  font-family: 'Lato', sans-serif;\n  background: rgba(244, 220, 204);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  margin: 15% auto;\n  padding: 20px;\n  border: 1px solid #888;\n  width: 80%;\n  border-radius: 30px;\n  text-align: center;\n}\n\n.travel-history,\n.pending-trips {\n  font-family: 'Lato', sans-serif;\n  display: flex;\n  justify-content: space-evenly;\n  align-content: stretch;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  align-items: center;\n  margin: 20px;\n}\n\n.card {\n  min-width: 300px;\n  background: rgba(244, 220, 204, 0.8);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  text-align: center;\n  border-radius: 30px;\n}\n\n.finance-card-container {\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n\n.finance-card {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgba(244, 220, 204, 0.8);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 30px;\n  max-width: calc(100% - 20px);\n}\n\n.chart-container {\n  max-width: 90%;\n  max-height: 250px;\n  height: 350px;\n  position: relative;\n  margin: 5px;\n}\n\n/* Media Queries */\n\n/* CSS for smaller screens */\n@media only screen and (max-width: 767px) {\n  header {\n    max-height: 50px !important;\n    padding: 10px !important;\n  }\n\n  .login-page {\n    height: 100vh;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n    background-image: none;\n    background-color: #b9799c; /* add background color here */\n  }\n\n  .login-form {\n    width: 100%;\n    max-width: 350px;\n    margin: 0 auto;\n    padding: 20px;\n    border-radius: 10px;\n    box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.2);\n  }\n\n  .dashboard-page {\n    background: linear-gradient(to bottom, #ffffff 30%, #b9799c 70%, #d68c7a 90%);\n  }\n\n  .traveler-trip,\n  .pending-trip {\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    margin: 20px 0;\n  }\n\n  .card {\n    max-width: 100%;\n    margin: 0 auto;\n  }\n\n  .finance-card {\n    max-width: 100%;\n    margin: 20px;\n  }\n\n  .chart-container {\n    max-width: 100%;\n    height: 250px;\n  }\n}\n\n/* CSS for larger screens */\n@media only screen and (min-width: 768px) {\n  header {\n    max-height: 98.83px !important;\n    padding: 20px !important;\n  }\n\n  .login-page {\n    height: 100vh;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n    background-image: none;\n    background-size: cover;\n  }\n\n  .login-form {\n    width: 500px;\n    padding: 30px;\n    border-radius: 30px;\n    box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.2);\n  }\n\n  .dashboard-page {\n    background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n  }\n\n  .traveler-trip,\n  .pending-trip {\n    flex-direction: row;\n    justify-content: space-between;\n    align-items: center;\n    margin: 20px;\n  }\n\n  .card {\n    max-width: 200px;\n    margin: 0;\n  }\n\n  .finance-card {\n    max-width: calc(50% - 20px);\n    margin: 20px;\n  }\n\n  .chart-container {\n    max-width: 50%;\n    height: 350px;\n  }\n}\n\n/* CSS Class for Hidden Elements*/\n.hidden {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/css/styles.css"],"names":[],"mappings":"AAAA,yBAAyB;AACzB;EACE,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,WAAW;EACX,eAAe;EACf,+BAA+B;EAC/B,aAAa;EACb,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,uCAAuC;EACvC,oCAAoC;EACpC,2CAA2C;EAC3C,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,mBAAmB;EACnB,UAAU;AACZ;;AAEA;;EAEE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;AACpB;;AAEA,0BAA0B;AAC1B;;EAEE,uCAAuC;EACvC,mBAAmB;EACnB,oCAAoC;EACpC,2CAA2C;EAC3C,aAAa;EACb,YAAY;EACZ,eAAe;EACf,eAAe;EACf,YAAY;AACd;;AAEA;;EAEE,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;;EAEE,YAAY;EACZ,qBAAqB;EACrB,eAAe;AACjB;;AAEA;;EAEE,+BAA+B;EAC/B,eAAe;EACf,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,8BAA8B;AAChC;;AAEA;EACE,eAAe;EACf,aAAa;EACb,sBAAsB;EACtB,kBAAkB;EAClB,+BAA+B;EAC/B,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,iCAAiC;EACjC,2CAA2C;AAC7C;;AAEA,eAAe;AACf;EACE,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,aAAa;EACb,+BAA+B;EAC/B,oCAAoC;EACpC,2CAA2C;EAC3C,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,oBAAoB;EACpB,6BAA6B;EAC7B,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,UAAU;EACV,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,WAAW;EACX,YAAY;EACZ,sBAAsB;EACtB,2BAA2B;EAC3B,UAAU;AACZ;;AAEA,mBAAmB;AACnB;EACE,aAAa;EACb,6EAA6E;AAC/E;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,eAAe;EACf,UAAU;EACV,WAAW;EACX,YAAY;EACZ,MAAM;EACN,OAAO;EACP,oCAAoC;AACtC;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,+BAA+B;EAC/B,+BAA+B;EAC/B,2CAA2C;EAC3C,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,UAAU;EACV,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;;EAEE,+BAA+B;EAC/B,aAAa;EACb,6BAA6B;EAC7B,sBAAsB;EACtB,mBAAmB;EACnB,iBAAiB;EACjB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,oCAAoC;EACpC,2CAA2C;EAC3C,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,WAAW;AACb;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,oCAAoC;EACpC,2CAA2C;EAC3C,mBAAmB;EACnB,4BAA4B;AAC9B;;AAEA;EACE,cAAc;EACd,iBAAiB;EACjB,aAAa;EACb,kBAAkB;EAClB,WAAW;AACb;;AAEA,kBAAkB;;AAElB,4BAA4B;AAC5B;EACE;IACE,2BAA2B;IAC3B,wBAAwB;EAC1B;;EAEA;IACE,aAAa;IACb,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,6EAA6E;IAC7E,sBAAsB;IACtB,yBAAyB,EAAE,8BAA8B;EAC3D;;EAEA;IACE,WAAW;IACX,gBAAgB;IAChB,cAAc;IACd,aAAa;IACb,mBAAmB;IACnB,0CAA0C;EAC5C;;EAEA;IACE,6EAA6E;EAC/E;;EAEA;;IAEE,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,cAAc;EAChB;;EAEA;IACE,eAAe;IACf,cAAc;EAChB;;EAEA;IACE,eAAe;IACf,YAAY;EACd;;EAEA;IACE,eAAe;IACf,aAAa;EACf;AACF;;AAEA,2BAA2B;AAC3B;EACE;IACE,8BAA8B;IAC9B,wBAAwB;EAC1B;;EAEA;IACE,aAAa;IACb,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,6EAA6E;IAC7E,sBAAsB;IACtB,sBAAsB;EACxB;;EAEA;IACE,YAAY;IACZ,aAAa;IACb,mBAAmB;IACnB,0CAA0C;EAC5C;;EAEA;IACE,6EAA6E;EAC/E;;EAEA;;IAEE,mBAAmB;IACnB,8BAA8B;IAC9B,mBAAmB;IACnB,YAAY;EACd;;EAEA;IACE,gBAAgB;IAChB,SAAS;EACX;;EAEA;IACE,2BAA2B;IAC3B,YAAY;EACd;;EAEA;IACE,cAAc;IACd,aAAa;EACf;AACF;;AAEA,iCAAiC;AACjC;EACE,aAAa;AACf","sourcesContent":["/* General CSS Elements */\n* {\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  width: 100%;\n  font-size: 20px;\n  font-family: 'Lato', sans-serif;\n  display: flex;\n  flex-direction: column;\n  overflow-x: hidden;\n}\n\nheader {\n  width: 100%;\n  font-family: 'Original Surfer', cursive;\n  background: rgba(244, 220, 204, 0.8);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  display: flex;\n  justify-content: space-between;\n  flex-direction: row;\n  align-items: center;\n  z-index: 1;\n}\n\nh1,\nh2 {\n  margin: 10px;\n}\n\nh2 {\n  display: flex;\n  justify-content: center;\n}\n\np {\n  text-align: center;\n}\n\n/* buttons & input fields*/\nbutton,\n.submit {\n  font-family: 'Original Surfer', cursive;\n  border-radius: 50px;\n  background: rgba(244, 220, 204, 0.5);\n  box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.25);\n  padding: 10px;\n  border: none;\n  font-size: 30px;\n  cursor: pointer;\n  margin: 15px;\n}\n\nbutton:hover,\n.submit:hover {\n  background-color: #544948;\n  color: white;\n}\n\n.close-btn {\n  margin: 10px;\n  color: black;\n  float: right;\n  font-size: 36px;\n  font-weight: bold;\n}\n\n.close {\n  color: #aaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n.confirm-button,\n.decline-button {\n  font-family: 'Lato', sans-serif;\n  font-size: 20px;\n  padding: 5px;\n}\n\n.input-box {\n  padding: 2%;\n  width: 500px;\n  justify-content: space-between;\n}\n\ninput {\n  font-size: 16px;\n  padding: 10px;\n  border: 1px solid #ccc;\n  border-radius: 5px;\n  font-family: 'Lato', sans-serif;\n  border-radius: 50px;\n}\n\ninput:focus {\n  outline: none;\n  border-color: rgba(0, 0, 0, 0.25);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n}\n\n/* Login Page */\n.login-page {\n  position: relative;\n  width: 100vw;\n  height: 100vh;\n  z-index: inherit;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.login-form {\n  display: flex;\n  padding: 15px;\n  font-family: 'Lato', sans-serif;\n  background: rgba(244, 220, 204, 0.5);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  width: 300px;\n  height: 190px;\n  flex-direction: column;\n  align-items: stretch;\n  justify-content: space-around;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 2;\n  border-radius: 30px;\n  padding: 20px;\n}\n\n.login-image {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-size: cover;\n  background-position: center;\n  z-index: 0;\n}\n\n/* Dashboard Page */\n.dashboard-page {\n  height: 100vh;\n  background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n}\n\n.dashboard-container {\n  height: 100%;\n}\n\n.book-trip {\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  align-items: center;\n}\n\n.modal {\n  display: none;\n  justify-content: center;\n  align-items: center;\n  position: fixed;\n  z-index: 1;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.modal.show {\n  display: flex;\n}\n\n.modal-content {\n  font-family: 'Lato', sans-serif;\n  background: rgba(244, 220, 204);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  margin: 15% auto;\n  padding: 20px;\n  border: 1px solid #888;\n  width: 80%;\n  border-radius: 30px;\n  text-align: center;\n}\n\n.travel-history,\n.pending-trips {\n  font-family: 'Lato', sans-serif;\n  display: flex;\n  justify-content: space-evenly;\n  align-content: stretch;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  align-items: center;\n  margin: 20px;\n}\n\n.card {\n  min-width: 300px;\n  background: rgba(244, 220, 204, 0.8);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  text-align: center;\n  border-radius: 30px;\n}\n\n.finance-card-container {\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n\n.finance-card {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgba(244, 220, 204, 0.8);\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 30px;\n  max-width: calc(100% - 20px);\n}\n\n.chart-container {\n  max-width: 90%;\n  max-height: 250px;\n  height: 350px;\n  position: relative;\n  margin: 5px;\n}\n\n/* Media Queries */\n\n/* CSS for smaller screens */\n@media only screen and (max-width: 767px) {\n  header {\n    max-height: 50px !important;\n    padding: 10px !important;\n  }\n\n  .login-page {\n    height: 100vh;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n    background-image: none;\n    background-color: #b9799c; /* add background color here */\n  }\n\n  .login-form {\n    width: 100%;\n    max-width: 350px;\n    margin: 0 auto;\n    padding: 20px;\n    border-radius: 10px;\n    box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.2);\n  }\n\n  .dashboard-page {\n    background: linear-gradient(to bottom, #ffffff 30%, #b9799c 70%, #d68c7a 90%);\n  }\n\n  .traveler-trip,\n  .pending-trip {\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    margin: 20px 0;\n  }\n\n  .card {\n    max-width: 100%;\n    margin: 0 auto;\n  }\n\n  .finance-card {\n    max-width: 100%;\n    margin: 20px;\n  }\n\n  .chart-container {\n    max-width: 100%;\n    height: 250px;\n  }\n}\n\n/* CSS for larger screens */\n@media only screen and (min-width: 768px) {\n  header {\n    max-height: 98.83px !important;\n    padding: 20px !important;\n  }\n\n  .login-page {\n    height: 100vh;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n    background-image: none;\n    background-size: cover;\n  }\n\n  .login-form {\n    width: 500px;\n    padding: 30px;\n    border-radius: 30px;\n    box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.2);\n  }\n\n  .dashboard-page {\n    background: linear-gradient(to bottom, #ffffff 30%, #d68c7a 70%, #b9799c 90%);\n  }\n\n  .traveler-trip,\n  .pending-trip {\n    flex-direction: row;\n    justify-content: space-between;\n    align-items: center;\n    margin: 20px;\n  }\n\n  .card {\n    max-width: 200px;\n    margin: 0;\n  }\n\n  .finance-card {\n    max-width: calc(50% - 20px);\n    margin: 20px;\n  }\n\n  .chart-container {\n    max-width: 50%;\n    height: 350px;\n  }\n}\n\n/* CSS Class for Hidden Elements*/\n.hidden {\n  display: none;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("images/travel-tracker-login.jpg");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "generateDonutChart": () => (/* binding */ generateDonutChart)
/* harmony export */ });
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
...
const generateDonutChart = (traveler) => {
  const totalSpent = traveler.getYearlySpent();

  const donutChartCanvas = document.getElementById('donutChartCanvas');

  const donutChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(donutChartCanvas, {
    type: 'doughnut',
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _dist_chart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
...
/* harmony export */ });
/* harmony import */ var _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/*!
 * Chart.js v4.2.1
...
/* harmony export */ });
/* harmony import */ var _kurkle_color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
/*!
 * Chart.js v4.2.1
 * https://www.chartjs.org
 * (c) 2023 Chart.js Contributors
...
class Traveler {
  ...
  getTravelerTrips() {
    if (!this.trips) {
      ...
      this.trips = trips.map(trip => new _Trip__WEBPACK_IMPORTED_MODULE_0__.default(trip, this.dataHandler));
    };
    return this.trips;
  };
...
/* harmony import */ var _images_travel_tracker_login_jpg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _src_charts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
/* harmony import */ var _src_Traveler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
/* harmony import */ var _src_DataHandler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(15);
/* harmony import */ var _src_Trip__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(14);
// Import API's
...
// Global Variables
let traveler;
const apiCalls = new _src_ApiCalls__WEBPACK_IMPORTED_MODULE_0__.default(),
  dataHandler = new _src_DataHandler__WEBPACK_IMPORTED_MODULE_6__.default();
...
const updateDashboard = (tripData, tripRequestLocation) => {
  const trip = new _src_Trip__WEBPACK_IMPORTED_MODULE_7__.default(tripData, dataHandler);
...
const getFetch = (userID) => {
  apiCalls.fetchAllData('trips')
    ...
    .then(travelerData => {
      traveler = new _src_Traveler__WEBPACK_IMPORTED_MODULE_5__.default(dataHandler, travelerData);
    ...
    .then(() => {
      ...
      const amountSpent = totalSpent / 1.1;
      const commission = totalSpent - amountSpent;
      (0,_src_charts__WEBPACK_IMPORTED_MODULE_3__.generateDonutChart)(traveler);
    })
    .catch(error => {
      console.error(error);
    });
